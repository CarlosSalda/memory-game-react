    ...
    <div
      className={`${
        gameOver ? "flex" : "hidden"
                     ...
                     bg-black absolute w-[250px] h-[300px] top-1/2 left-1/2 -translate-x-1/2
                       -translate-y-1/2 z-40 rounded-lg`}
    >
      <svg
      ...
      <button className="text-white font-bold absolute right-0 top-0 mr-3 hover:text-yellow-500" onClick={() => setGameOver(false)}>
        &times;
      </button>
    </div>
  );
